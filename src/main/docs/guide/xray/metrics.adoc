...
Use the following configuration to disable `MetricSegmentListener` automatic configuration.

include::{includedir}configurationProperties/io.micronaut.tracing.aws.configuration.XRayCloudWatchMetricsConfigurationProperties.adoc[]