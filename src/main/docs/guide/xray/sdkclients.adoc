...
You can disable AWS SDK beans automatic configuration with the following configuration:

include::{includedir}configurationProperties/io.micronaut.tracing.aws.configuration.XRaySdkClientsConfigurationProperties.adoc[]
