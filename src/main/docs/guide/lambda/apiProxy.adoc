...
TIP: In Micronaut 1.1 or above you can create an API proxy ready application with `mn create-app myapp --features aws-api-proxy`
...
The `getAwsProxyHandler()` method also accepts a `ApplicationContextBuilder` instance which you can use to further customizate application bootstrap.
