...
You can configure the MDC Key population with:

include::{includedir}configurationProperties/io.micronaut.function.aws.logging.MappingDiagnosticContextConfigurationProperties.adoc[]
