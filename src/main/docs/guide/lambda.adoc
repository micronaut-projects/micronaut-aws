Regular Micronaut functions created via `mn create-function-app` can be deployed to Lambda directly. 
...
For example, when using `create-function-app hello` Micronaut 1.1 and above will create a function that looks like this:
