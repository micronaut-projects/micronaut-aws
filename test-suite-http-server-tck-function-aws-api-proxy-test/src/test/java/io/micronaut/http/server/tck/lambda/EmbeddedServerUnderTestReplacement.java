 ...
 */
@Experimental
public class EmbeddedServerUnderTestReplacement implements ServerUnderTest {
    ...
    public EmbeddedServerUnderTestReplacement(@NonNull Map<String, Object> properties) {
