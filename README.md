...
* [Edit the version](https://github.com/micronaut-projects/micronaut-aws/edit/master/gradle.properties) specified by `version` in `gradle.properties` to a semantic, unreleased version. Example `1.0.0`
