...
import io.micronaut.function.aws.proxy.cookies.CookieFactory;
...
public abstract class AbstractServletHttpResponse<R, B> implements ServletHttpResponse<R, B> {
    ...
    protected final CookieEncoder cookieEncoder;
    ...
    public MutableHttpResponse<B> cookie(Cookie cookie) {
        header(HttpHeaders.SET_COOKIE, cookieEncoder.encode(cookie));
        return this;
    }
