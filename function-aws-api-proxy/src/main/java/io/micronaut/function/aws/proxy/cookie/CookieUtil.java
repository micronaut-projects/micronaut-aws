...
/**
 * Note: Forked from Netty `io.netty.handler.codec.http.cookie.CookieUtil`.
 */
@Internal
final class CookieUtil {
     ...
     */
    static String stripTrailingSeparatorOrNull(StringBuffer buf) {
        return buf.length() == 0 ? null : stripTrailingSeparator(buf);
    }

    static String stripTrailingSeparator(StringBuffer buf) {
        if (buf.length() > 0) {
    ...
    static void add(StringBuffer sb, String name, long val) {
        sb.append(name);
        sb.append('=');
        sb.append(val);
        sb.append(';');
    ...
    static void add(StringBuffer sb, String name, String val) {
        sb.append(name);
        sb.append('=');
        sb.append(val);
        sb.append(';');
    ...
    static void add(StringBuffer sb, String name) {
        sb.append(name);
        sb.append(';');
        sb.append(HttpConstants.SP_CHAR);
    }

    static void addQuoted(StringBuffer sb, String name, String val) {
        if (val == null) {
            val = "";
        }
