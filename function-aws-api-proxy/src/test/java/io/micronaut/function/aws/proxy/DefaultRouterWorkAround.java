...
public class DefaultRouterWorkAround implements Router, HttpServerFilterResolver<RouteMatch<?>> {
     ...
     */
    @Inject
    public DefaultRouterWorkAround(Collection<RouteBuilder> builders) {
     ...
     * @param builders The builders
     */
    public DefaultRouterWorkAround(RouteBuilder... builders) {
