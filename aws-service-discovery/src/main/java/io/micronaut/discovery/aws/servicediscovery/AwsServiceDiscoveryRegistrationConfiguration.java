...
@Requires(property = AwsServiceDiscoveryRegistrationConfiguration.PREFIX + ".enabled", value = "true")
@ConfigurationProperties(AwsServiceDiscoveryRegistrationConfiguration.PREFIX)
public class AwsServiceDiscoveryRegistrationConfiguration extends RegistrationConfiguration {

    public static final String PREFIX = AwsServiceDiscoveryConfiguration.PREFIX + ".registration";
