...
public class SkillRequestTimestampVerifier implements SkillServletVerifier {
     ...
     *            {@value AskHttpServerConstants#MAXIMUM_TOLERANCE_MILLIS}.
     */
    public SkillRequestTimestampVerifier(final long toleranceInMilliseconds) {
        if (toleranceInMilliseconds > AskHttpServerConstants.MAXIMUM_TOLERANCE_MILLIS) {
            throw new IllegalArgumentException(String.format("Provided tolerance value %s exceeds the maximum"
                    + " allowed %s", toleranceInMilliseconds, AskHttpServerConstants.MAXIMUM_TOLERANCE_MILLIS));
     ...
     *            {@value AskHttpServerConstants#MAXIMUM_TOLERANCE_MILLIS} after converting to milliseconds.
     * @param timeUnit
