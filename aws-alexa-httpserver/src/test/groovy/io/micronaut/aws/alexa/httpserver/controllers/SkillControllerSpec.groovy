...
class SkillControllerSpec extends EmbeddedServerSpecification implements RequestEnvelopFixture {

    @Override
    String getSpecName() {
        SkillControllerSpec.simpleName
    }
    ...
    @Requires(property = 'spec.name', value = 'SkillControllerSpec')
    @Singleton
