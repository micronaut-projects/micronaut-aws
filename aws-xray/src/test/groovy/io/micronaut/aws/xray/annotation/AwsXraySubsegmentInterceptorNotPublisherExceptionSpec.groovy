...
@Property(name = "spec.name", value = "AwsXraySubsegmentInterceptorNotPublisherExceptionSpec")
@MicronautTest
class AwsXraySubsegmentInterceptorNotPublisherExceptionSpec extends Specification {
    @Inject
    @Client("/")
    ...
    void "AwsXraySubsegmentInterceptor adds the exception thrown in the method to the subsegment"() {
        given:
    ...
    @Requires(property = 'spec.name', value = 'AwsXraySubsegmentInterceptorNotPublisherExceptionSpec')
    @Singleton
