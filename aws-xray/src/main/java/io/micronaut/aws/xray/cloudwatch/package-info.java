...
@Requires(property = XRayConfigurationProperties.PREFIX + ".cloud-watch-metrics", notEquals = StringUtils.FALSE, defaultValue = StringUtils.TRUE)
@Configuration
package io.micronaut.aws.xray.cloudwatch;
