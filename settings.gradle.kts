...
include("test-suite-groovy-aws-sdk-v2-http-client-apache4")
include("test-suite-groovy-aws-sdk-v2-http-client-apache5")
include("test-suite-groovy-aws-sdk-v2-http-client-crt")
include("test-suite-groovy-aws-sdk-v2-http-client-netty")
include("test-suite-groovy-aws-sdk-v2-http-client-urlconnection")
include("test-suite-function-client-aws-groovy")
