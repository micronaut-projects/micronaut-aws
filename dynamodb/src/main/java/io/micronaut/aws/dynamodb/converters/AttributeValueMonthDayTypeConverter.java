 ...
 */
@Singleton
public class AttributeValueMonthDayTypeConverter implements TypeConverter<AttributeValue, MonthDay> {
    private static final Logger LOG = LoggerFactory.getLogger(AttributeValueMonthDayTypeConverter.class);
