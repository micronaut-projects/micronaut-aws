...
class MockAWSServiceDiscoveryAsync implements AWSServiceDiscoveryAsync {
    ...
    @Override
    Future<CreateHttpNamespaceResult> createHttpNamespaceAsync(CreateHttpNamespaceRequest createHttpNamespaceRequest, AsyncHandler<CreateHttpNamespaceRequest, CreateHttpNamespaceResult> asyncHandler) {
        return null
    }
    ...
    @Override
    Future<DiscoverInstancesResult> discoverInstancesAsync(DiscoverInstancesRequest discoverInstancesRequest, AsyncHandler<DiscoverInstancesRequest, DiscoverInstancesResult> asyncHandler) {
        return null
    }
