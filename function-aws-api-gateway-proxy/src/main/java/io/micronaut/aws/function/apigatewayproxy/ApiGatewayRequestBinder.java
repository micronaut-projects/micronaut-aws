 ...
 */
@Internal
public class ApiGatewayRequestBinder implements TypedRequestArgumentBinder<APIGatewayProxyRequestEvent> {
    ...
    public BindingResult<APIGatewayProxyRequestEvent> bind(
        ...
        if (source instanceof ApiGatewayProxyServletRequest<?>) {
            ...
            return () -> Optional.of(apiGatewayProxyServletRequest.getNativeRequest());
        }
